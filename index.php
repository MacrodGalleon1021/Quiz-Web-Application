<?php
session_start();
include 'conn.php';  // Changed from db.php to conn.php

// Handle user input (first name and last name)
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    header("Location: quiz.php"); // Redirect to quiz page
    exit;
}
?>
...
<body>
    ...
    <!-- User Login Form (First Name and Last Name) -->
    <form method="POST">
